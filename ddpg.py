...
class DDPG(object):
    def __init__(self, state_shape, action_dim, max_action, lr, gamma, tau, batch_size, buffer_size=1e6):
        ...
        self.buffer_ptr = 0
        self.buffer_head = 0 
        self.random_transition = 10000 # collect 5k random data for better exploration
    ...
    def get_action(self, observation, evaluation=False):
        ...
        if (self.buffer_ptr < self.random_transition) and not evaluation: # collect random trajectories for better exploration.
            ...
            expl_noise = 0.9 * self.max_action # the stddev of the expl_noise if not evaluation
